...
const games = [
  ...
  { icon: Gavel, title: "Bid Bonanza", desc: "Fast-paced startup bidding war. Analyze opportunities, manage your budget, and build the strongest investment portfolio.", difficulty: "Hard", xp: "100-300", time: "10-12 min", players: 413, link: "/games/bid-bonanza" },
];
